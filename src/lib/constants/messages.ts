...
export const SERVER_RUNNING_ON_PORT = 'Server running on port';
...
export const LOGOUT_UNSUCCESSFUL = 'Logout unsuccessful, please try again';
...
export const USER_NOT_FOUND = 'No user found, please try again';
export const UNAUTHORIZED_USER = 'Unauthorized. User not found.';
